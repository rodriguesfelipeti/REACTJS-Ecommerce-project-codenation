...
function Header(props) {
    ...
    const handeClick = (event, window) => {
        ...
        props.windowStateReducer(window)
    }
            ...
            <div className="app__container">
                <div className="header__default">
                    ...
                    <div className="header__iconsApp">
                        <Button className="header__icons--search" handleClick={ event => handeClick(event, 'search')}>
                        ...
                        <Button className="header__icons--cart" handleClick={ event => handeClick(event, 'cart')}>
                            <svg stroke="currentColor" fill="none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <sup className="counter">
                                <span className="counter__value">{props.cart.length}</span>
                            </sup>
                            <canvas className="header__canvas" height="0" width="0"></canvas>
                        </Button>
                    </div>
