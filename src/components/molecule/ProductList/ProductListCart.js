...
class ProductListCart extends React.Component {
    ...
    addQtdCartItem = (event, index) => {
        event.preventDefault()

        this.props.incrementCart(index)
    }
    
    removeQtdCartItem = (event, index) => {
        event.preventDefault()
    
        this.props.decrementCart(index)
    }

    removeCartItem = (event, index) => {
        event.preventDefault()

        this.props.removeItemCart(index)
    }   
                ...
                <div className="product__list">
                    <div className="product__list__item">
                        <div className="product__list__row">
                            ...
                            <div className="product__list__info">
                                ...
                                <div className="product__list__quantity">
                                    <Button className="cart__icons" handleClick={event => this.removeQtdCartItem(event, this.props.index)}>
                                    ...
                                    <Button className="cart__icons" handleClick={event => this.addQtdCartItem(event, this.props.index)}>
                                        <svg stroke="currentColor" fill="   none" strokeWidth="2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="product__row">
                            <Button className="cart__remove" titleButton="Remover item" handleClick={event => this.removeCartItem(event, this.props.index)}>
                                <canvas height="0" width="0" styles="border-radius: inherit; height: 100%; left: 0px; position: absolute; top: 0px; width: 100%;"></canvas>
                            </Button>
                        </div>
                    </div>
                </div>
                <div className="cart__subtotal"><div className="header__title">Subtotal - R$ { this.formatTotalPrice(this.props.totalCart) }</div></div>
            </div> 
